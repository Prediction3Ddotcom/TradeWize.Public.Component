...
const NativeInfinitePicker = requireNativeComponent('InfinitePickerView');
const WheelMonthYearPicker = props => {
    ...
    if (Platform.OS === 'ios') {
      return /*#__PURE__*/_jsxs(View, {
        ...
        children: [/*#__PURE__*/_jsx(View, {
          ...
          children: /*#__PURE__*/_jsx(NativeInfinitePicker, {
            infiniteLoop: true,
  ...
  }, [indicatorColor, onItemSelected, selectedItem.month, selectedItem.year, stylePickerContainer, stylePickerIosItem, title, wheelMonthData, years]);
