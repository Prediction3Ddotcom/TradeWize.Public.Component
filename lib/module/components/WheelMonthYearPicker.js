...
const WheelMonthYearPicker = props => {
  ...
  return /*#__PURE__*/_jsx(ReactNativeModal, {
    ...
    children: /*#__PURE__*/_jsxs(View, {
      ...
      children: [renderHeader, renderWheelPickerByPlatform, /*#__PURE__*/_jsxs(View, {
        style: styles.footerContainerWithPadding,
        children: [/*#__PURE__*/_jsx(Button, {
          textStyle: styleTextConfirm,
          title: textConfirm || 'Confirm',
          style: [styles.buttonFooter, styles.buttonConfirm, styleButtonConfirm],
          onPress: handleConfirm
        }), /*#__PURE__*/_jsx(Button, {
          textStyle: [styles.buttonTextCancel, styleTextCancel],
          title: textCancel || 'Cancel',
          style: [styles.buttonFooter, styles.buttonCancel, styleButtonCancel],
          variant: "secondary",
          onPress: onCancel
        })]
      })]
