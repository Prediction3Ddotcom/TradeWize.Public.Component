  ...
  const renderReactionEmoji = useCallback(() => {
    ...
    if (reactionEmoji && reactionEmoji?.length > 0) {
      return /*#__PURE__*/_jsxs(View, {
        style: [styles.content.reactionEmojiContainer, {
        ...
        children: [reactionEmoji?.map((item, index) => /*#__PURE__*/_jsx(Text, {
          ...
          style: styles.content.reactionEmojiCount,
      ...
      children: /*#__PURE__*/_jsx(TouchableWithoutFeedback, {
        ...
        children: /*#__PURE__*/_jsxs(View, {
          ...
          children: [renderBubbleContent(), /*#__PURE__*/_jsxs(View, {
            style: [styles[position].bottom, bottomContainerStyle?.[position], currentMessage?.reactionEmoji && currentMessage?.reactionEmoji?.length > 0 && styles.content.reactionMarginBottom],
