...
import { StyleSheet, Pressable, Text, Modal, Dimensions, TouchableOpacity } from 'react-native';
const {
  width: screenWidth,
  height: screenHeight
...
export const MessageWithReaction = ({
  ...
  }, [isVisible, isShowEmoji, user?._id, message?.user?._id, isMyMessage, overlayOpacity, messageScale, messageOpacity, reactionIconOpacity, actionButtonsOpacity]);
  ...
  const styleReactionIcon = useCallback(() => {
    ...
    if (position.pageY < 80) {
      ...
      top = position.pageY - SCREEN_HEIGHT * 0.05 - 8;
    } else {
      top = position.pageY - SCREEN_HEIGHT * 0.05 - differenceLevel - DIFFERENCE_LEVEL - 8;
    }
  ...
  const styleLayoutAction = useCallback(() => {
    let top = 0;
    if (position.pageY < 80) {
      top = 80 + SCREEN_HEIGHT * 0.05 + 8 + position.height;
    } else if (!isExceedsScreenHeight) {
  ...
  const renderTime = useMemo(() => /*#__PURE__*/_jsx(Time, {
  ...
  return /*#__PURE__*/_jsx(Modal, {
    ...
    children: /*#__PURE__*/_jsxs(Animated.View, {
      ...
      children: [/*#__PURE__*/_jsx(Pressable, {
        ...
        pointerEvents: "none"
      }), isShowEmoji && user?._id !== message?.user?._id && /*#__PURE__*/_jsx(Animated.View, {
        style: [styles.reactionIcon, styleReactionIcon(), reactionIconAnimatedStyle],
        children: EMOJI_REACTIONS?.map(emoji => /*#__PURE__*/_jsx(Pressable, {
          onPress: () => {
            onClose();
        ...
        children: [renderFile, renderMessage, renderTime]
      }), /*#__PURE__*/_jsxs(Animated.View, {
        ...
        }), message?.text && /*#__PURE__*/_jsxs(TouchableOpacity, {
          style: [styles.btnAction],
          onPress: () => {
            onClose();
