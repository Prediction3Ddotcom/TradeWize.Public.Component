...
import DaysGridView from "./DaysGridView.js";
...
export default class CalendarPicker extends Component {
  ...
  updateMonthYear = (initialDate = this.props.initialDate, updateState) => {
    const newState = {
      currentMonth: parseInt(getMonth(new Date(initialDate)).toString()),
      currentYear: parseInt(getYear(new Date(initialDate)).toString())
    };
    if (updateState) {
  ...
  createMonths = (props, {
    ...
    let _initialDate = Number.isInteger(currentMonth) && Number.isInteger(currentYear) && new Date(currentYear, currentMonth, 1, 12);
  ...
  renderMonth(props) {
    return /*#__PURE__*/_jsx(DaysGridView, {
      ...props
    });
  }
  render() {
    ...
    switch (currentView) {
      case 'months':
        content = /*#__PURE__*/_jsx(MonthSelector, {
          styles: styles,
          textStyle: textStyle,
        ...
        break;
      case 'years':
        content = /*#__PURE__*/_jsx(YearSelector, {
          styles: styles,
          textStyle: textStyle,
      ...
      default:
        content = /*#__PURE__*/_jsxs(View, {
          ...
          children: [/*#__PURE__*/_jsx(HeaderControls, {
            styles: styles,
            currentMonth: currentMonth,
            currentYear: currentYear,
            initialDate: new Date(initialDate),
          ...
          }), scrollable ? /*#__PURE__*/_jsx(Scroller, {
