...
export default function Day(props) {
  ...
  let isThisDateInSelectedRange = selectedStartDate && selectedEndDate && isWithinInterval(thisDay, {
  ...
  if (!dateOutOfRange || isThisDaySameAsSelectedStart || isThisDaySameAsSelectedEnd || isThisDateInSelectedRange) {
    ...
    const custom = getCustomDateStyle({
      customDatesStyles,
      date: thisDay
    });
    ...
    if (allowRangeSelection) {
      if (selectedStartDate && selectedEndDate) {
        ...
        if (!isThisDaySameAsSelectedEnd && !isThisDaySameAsSelectedStart && isWithinInterval(thisDay, {
          start: selectedStartDate,
          end: selectedEndDate
        })) {
    ...
    return /*#__PURE__*/_jsx(View, {
      style: [styles.dayWrapper, custom.containerStyle],
      children: /*#__PURE__*/_jsx(View, {
        style: [styles.dayButton, custom.style],
        children: /*#__PURE__*/_jsx(Text, {
