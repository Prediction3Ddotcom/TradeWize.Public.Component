...
export default class CalendarScroller extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.data !== prevProps.data) {
      ...
      newState = {
        ...newState,
        ...this.updateMonthsData(this.props.data)
      };
    }
  ...
  shiftMonthsBackward = currentMonth => {
    this.shiftMonths(currentMonth, (this.state.numMonths || 0) * 2 / 3);
  };
  ...
  rowRenderer = (_type, rowMonth, _i, extState) => {
    const {
      updateMonthYear,
      renderMonth
    } = this.props;
    ...
    return renderMonth && renderMonth({
      ...extState,
      month,
      year
    });
  ...
  render() {
    ...
    return /*#__PURE__*/_jsx(View, {
      ...
      children: /*#__PURE__*/_jsx(RecyclerListView, {
