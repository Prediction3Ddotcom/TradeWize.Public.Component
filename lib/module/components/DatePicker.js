...
export function DatePicker({
  ...
  const [pickerView, setPickerView] = useState('date');
  ...
  const [selectedYear, setSelectedYear] = useState(() => {
    if (value) {
      return parseInt(value.split('-')[0] ?? String(new Date().getFullYear()), 10);
    }
    return new Date().getFullYear();
  });
  const [currentDecade, setCurrentDecade] = useState(() => {
    const year = value ? parseInt(value.split('-')[0] ?? String(new Date().getFullYear()), 10) : new Date().getFullYear();
  ...
  const formatDisplayDate = useCallback((date, format) => {
    ...
    return finalFormat.replace('DD', day ?? '').replace('MM', month ?? '').replace('YYYY', year ?? '');
  }, [dateFormat, formatDate, placeholder]);
  const displayText = useMemo(() => formatDisplayDate(value, formatTypeDateDisplayText), [value, formatDisplayDate, formatTypeDateDisplayText]);
  ...
  const renderMonthPicker = () => {
    const listMonth = Array.from({
      length: 12
    }, (_, i) => new Date(0, i).toLocaleString(localeConfig, {
      month: 'long'
    }));
    return /*#__PURE__*/_jsxs(View, {
      style: styles.pickerContainer,
      children: [/*#__PURE__*/_jsxs(View, {
        style: [styles.pickerHeader, styles.pickMonthHeader],
        ...
        children: listMonth.map((month, index) => {
          const monthNum = index + 1;
          const monthDate = `${selectedYear}-${String(monthNum).padStart(2, '0')}-01`;
          const isSelected = currentMonth === `${selectedYear}-${String(monthNum).padStart(2, '0')}`;
          const isMonthDisabled = minDate && monthDate < minDate || maxDate && monthDate > maxDate;
          return /*#__PURE__*/_jsx(Pressable, {
            style: [styles.monthItem, isSelected && {
            ...
            children: /*#__PURE__*/_jsx(CustomText, {
              variant: "body",
              style: [styles.monthText, isSelected && {
  ...
  const renderYearPicker = () => {
    ...
    return /*#__PURE__*/_jsxs(View, {
      style: styles.pickerContainer,
      children: [/*#__PURE__*/_jsxs(View, {
        style: [styles.pickerHeader, styles.pickYearHeader],
        children: [/*#__PURE__*/_jsx(Pressable, {
          onPress: handlePreviousDecade,
          style: styles.decadeButton,
          children: /*#__PURE__*/_jsx(CustomText, {
            variant: "body",
            style: [styles.decadeArrow, {
              color: borderColorActive
            }],
            children: "\u2039"
          })
        }), /*#__PURE__*/_jsxs(CustomText, {
          variant: "h6",
          color: "primary",
        ...
        children: years.map(year => {
          ...
          const isYearDisabled = minDate && year < parseInt(minDate.split('-')[0] ?? '0', 10) || maxDate && year > parseInt(maxDate.split('-')[0] ?? '9999', 10);
          return /*#__PURE__*/_jsx(Pressable, {
            style: [styles.yearItem, isSelected && {
              backgroundColor: dynamicStyles.selectedDayBackgroundColor
            ...
            children: /*#__PURE__*/_jsx(CustomText, {
              variant: "body",
              style: [styles.yearText, isSelected && {
                color: selectedDayTextColor
              }, !isSelected && {
                color: dynamicStyles.textColor
  ...
  const renderModalContent = () => {
    ...
    return /*#__PURE__*/_jsx(Modal, {
      ...
      children: /*#__PURE__*/_jsx(ShadowedView, {
        style: [styles.shadowContainer, Platform.OS === 'ios' && styles.shadowContainerIOS, Platform.OS === 'android' && styles.shadowContainerAndroid, {
          ...
          children: /*#__PURE__*/_jsx(View, {
            ...
            children: /*#__PURE__*/_jsxs(Pressable, {
              ...
              children: [renderModalHeader ? renderModalHeader(modalTitle ?? label ?? 'Chọn ngày', handleCloseModal) : /*#__PURE__*/_jsx(View, {
                ...
                children: [pickerView === 'date' && /*#__PURE__*/_jsx(Calendar, {
                ...
                }), pickerView === 'month' && renderMonthPicker(), pickerView === 'year' && renderYearPicker()]
