...
import { View, StyleSheet, Pressable, FlatList, TextInput, StatusBar, Dimensions, Image } from 'react-native';
...
export function SelectBox({
  ...
  return /*#__PURE__*/_jsxs(View, {
    ...
    children: [label && (renderLabel ? renderLabel(label, isRequired) : /*#__PURE__*/_jsx(View, {
      ...
      }), selectedValues?.length > 0 && !isDisabled && showClearButton && (renderClearButton ? renderClearButton(handleClearSelection) : /*#__PURE__*/_jsx(Button, {
        variant: "ghost",
        onPress: e => {
          e.stopPropagation();
