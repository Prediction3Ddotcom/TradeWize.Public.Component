...
import { TextInput, View, StyleSheet, Pressable, useColorScheme } from 'react-native';
...
export function Input({
  ...
  const getInputContainerStyles = () => {
    ...
    const variantStyles = {
      outline: {
        borderWidth: 1,
        borderColor: hasError ? '#FF3B30' : isFocused ? isDark ? '#0A84FF' : '#007AFF' : isDark ? '#3A3A3C' : '#C7C7CC',
      ...
      filled: {
        ...
        borderBottomWidth: 2,
        borderBottomColor: hasError ? '#FF3B30' : isFocused ? isDark ? '#0A84FF' : '#007AFF' : 'transparent'
      },
      underline: {
        borderWidth: 0,
        borderBottomWidth: 1,
        borderBottomColor: hasError ? '#FF3B30' : isFocused ? isDark ? '#0A84FF' : '#007AFF' : isDark ? '#3A3A3C' : '#C7C7CC',
