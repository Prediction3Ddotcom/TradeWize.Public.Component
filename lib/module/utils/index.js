...
export const responsiveFontSize = (size, options = {}) => {
  const {
    baseWidth = 375,
    // Chiều rộng thiết kế chuẩn (iPhone X)
    baseHeight = 812,
    // Chiều cao thiết kế chuẩn
    minScale = 0.8,
    // Tỷ lệ scale tối thiểu
...
export { BASE_WIDTH, BASE_HEIGHT, scaleSize, width as SCREEN_WIDTH, height as SCREEN_HEIGHT };
