...
export declare function DatePicker({ label, placeholder, helperText, errorText, value, onChange, minDate, maxDate, leftIcon, rightIcon, variant, size, isDisabled, isError, isRequired, fullWidth, shadowColor, noteDescription, enableMonthYearPicker, localeConfig, numberOfLinesErrorText, formatTypeDateDisplayText, containerStyle, inputStyle, labelStyle, inputContainerStyle, helperTextStyle, errorTextStyle, shadowContentStyle, noteDescriptionStyle, modalStyle, modalOverlayStyle, modalContentStyle, modalHeaderStyle, modalFooterStyle, modalTitleStyle, leftIconContainerStyle, rightIconContainerStyle, chevronIconStyle: customChevronIconStyle, borderColorActive, borderColorError, borderColor, backgroundColor, textColor, placeholderColor, modalBackgroundColor, selectedDayBackgroundColor, selectedDayTextColor, todayTextColor, maxHeight, modalPosition, animationInTiming, animationOutTiming, backdropOpacity, onModalShow, onModalHide, onModalWillShow, onModalWillHide, swipeDirection, onSwipeComplete, swipeThreshold, backdropColor, backdropTransitionInTiming, backdropTransitionOutTiming, hideModalContentWhileAnimating, avoidKeyboard, coverScreen, hasBackdrop, customBackdrop, monthNames, modalTitle, confirmButtonText, cancelButtonText, confirmButtonStyle, confirmButtonTextStyle, cancelButtonStyle, cancelButtonTextStyle, renderLabel, renderDisplayText, renderModalHeader, renderModalFooter, renderLeftIcon, renderRightIcon, renderChevron, onOpen, onClose, onFocus, onBlur, onClear, calendarTheme, markedDates: customMarkedDates, markingType, firstDayOfWeek, showWeekNumbers, disableAllTouchEventsForDisabledDays, enableSwipeMonths, hideExtraDays, hideDayNames, hideArrows, monthFormat, dateFormat, formatDate, accessibilityLabel, accessibilityHint, testID, modalTestID, }: DatePickerProps): import("react/jsx-runtime").JSX.Element;
