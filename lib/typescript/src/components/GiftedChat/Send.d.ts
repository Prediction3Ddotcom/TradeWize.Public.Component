...
export declare const Send: <TMessage extends IMessage = IMessage>({ text, containerStyle, children, alwaysShowSend, sendButtonProps, onSend, iconStyle, iconSend, disableComposer, }: SendProps<TMessage>) => import("react/jsx-runtime").JSX.Element | null;
