...
export const Utils = {
  ...
  isSameMonthAndYear: function (date: Date, month: number, year: number) {
    if (date) {
  ...
  shallowDiff: function (a: any, b: any, exclusions: string[] = []) {
    const diffs = [];
  ...
  compareDates: function (a: Date, b: Date, granularity: 'day' | 'month') {
