...
export const VideoModal: React.FC<VideoModalProps> = ({
  ...
  const [currentSubtitleLanguage, setCurrentSubtitleLanguage] =
    useState<string>(initialSubtitle);
  ...
  const loadFileSubtitle = useCallback(
    async (language: string = currentSubtitleLanguage) => {
      try {
    ...
    >
      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          {isSubtitle && availableLanguages.length > 1 && !error && (
            <View
              style={[
                ...
                { top: insets.top + TOP_OFFSET, left: isRateControl ? 90 : 16 },
              ]}
            >
              <TouchableOpacity
          ...
          {isRateControl && (
            <View
              style={[styles.rateContainer, { top: insets.top + TOP_OFFSET }]}
            >
              <TouchableOpacity
